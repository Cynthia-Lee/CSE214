		...
		do {
			...
			if (option.equalsIgnoreCase("A")) {
				...
				if (current.getCursor() != null) {
					...
					System.out.println("Cursor cannot be set to head because head does not exist.");
				}
				System.out.println();
				...
				if (current.getCursor() != null) {
					...
					System.out.println("Cursor cannot be set to tail because tail does not exist.");
				}
				System.out.println();
